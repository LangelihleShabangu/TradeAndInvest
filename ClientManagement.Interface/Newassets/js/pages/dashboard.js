...
var KTDashboard = function() {
    ...
    var widgetTotalClientChart2 = function () {
        if (!document.getElementById('kt_widget_total_Client_chart_2')) {
            return;
        }
        ...
        var ctx = document.getElementById('kt_widget_total_Client_chart_2').getContext("2d");
        var gradient = ctx.createLinearGradient(0, 0, 0, 120);
        gradient.addColorStop(0, Chart.helpers.color(color).alpha(0.3).rgbString());
        gradient.addColorStop(1, Chart.helpers.color(color).alpha(0).rgbString());
