...
namespace VIcocaApplication.UI.Controllers
{
    ...
    {
        public ActionResult DynamicReportDetails(DateTime StartDate, DateTime Enddate)
        {
        ...
        public ActionResult Index()
        {
            ...
            dashBoardDomainModel.DynamicReport =  BusinessObject.DynamicReportDetails().ToArray();
        ...
        {
            DashBoardDomainModel dashBoardDomainModel = new DashBoardDomainModel();
            return Json(BusinessObject.GetMapDetails(), JsonRequestBehavior.AllowGet);
        }
        ...
        //for (int i = 1; i <= DateTime.Now.Month; i++)
        //{
        //    Company company = new Company() { Expense = BusinessObject.GetMaterialDetails(i,DateTime.Now.Year), Salary = dashboardData.GetSalesDetails(i, DateTime.Now.Year), Year = new DateTime(DateTime.Now.Year, i, 1).ToString("yyyy/MM") };
        //    companies.Add(company);
        //}
